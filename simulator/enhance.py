...
PROBS: dict[str, list[float]] = {
    ...
    '+4' : [0.90, 0.85, 0.80, 0.75, 0.70, 0.65, 0.60],
    '+5' : [0.80, 0.75, 0.70, 0.65, 0.60, 0.55, 0.50],
    '+6' : [0.70, 0.65, 0.60, 0.55, 0.50, 0.45, 0.40],
    '+7' : [0.60, 0.55, 0.50, 0.45, 0.40, 0.35, 0.30],
    '+8' : [0.50, 0.45, 0.40, 0.35, 0.30, 0.25, 0.20],
    '+9' : [0.40, 0.35, 0.30, 0.25, 0.20, 0.15, 0.10],
    '+10': [0.20, 0.17, 0.15, 0.12, 0.10, 0.07, 0.05],
}
...
ENERGY: dict[str, dict[str, float]] = {
    ...
    '+7' : {'energy_per_fail':  8.0, 'boost': 1.0},   # 천장 13회
    '+8' : {'energy_per_fail':  6.0, 'boost': 1.0},   # 천장 17회
    '+9' : {'energy_per_fail':  5.0, 'boost': 1.0},   # 천장 20회
    '+10': {'energy_per_fail':  4.0, 'boost': 1.0},   # 천장 25회
}
