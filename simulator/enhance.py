...
PROBS: dict[str, list[float]] = {
    ...
    '+2' : [0.87,  0.83,  0.79,  0.74,  0.70,  0.65,   0.60  ],
    '+3' : [0.82,  0.78,  0.74,  0.69,  0.64,  0.59,   0.54  ],
    '+4' : [0.77,  0.73,  0.69,  0.64,  0.59,  0.54,   0.49  ],
    '+5' : [0.30,  0.22,  0.16,  0.11,  0.08,  0.050,  0.035 ],  # 주요 관문
    '+6' : [0.25,  0.20,  0.16,  0.12,  0.09,  0.055,  0.040 ],
    '+7' : [0.20,  0.16,  0.11,  0.08,  0.06,  0.040,  0.025 ],
    '+8' : [0.12,  0.09,  0.07,  0.05,  0.035, 0.020,  0.015 ],
    '+9' : [0.07,  0.05,  0.035, 0.022, 0.014, 0.008,  0.005 ],
    '+10': [0.04,  0.025, 0.015, 0.008, 0.005, 0.0025, 0.0015],
}
