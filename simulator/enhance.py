...
PROBS: dict[str, list[float]] = {
    ...
    '+5' : [0.80,  0.72,  0.64,  0.55,  0.46,  0.38,  0.30],
    '+6' : [0.60,  0.50,  0.40,  0.30,  0.22,  0.15,  0.10],
    '+7' : [0.40,  0.30,  0.22,  0.15,  0.10,  0.06,  0.04],
    '+8' : [0.20,  0.14,  0.09,  0.06,  0.035, 0.020, 0.015],
    '+9' : [0.10,  0.07,  0.04,  0.025, 0.015, 0.008, 0.005],
    '+10': [0.05,  0.03,  0.016, 0.009, 0.005, 0.0025,0.0015],
}
